              ...
              <MDBModalContent>
                ...
                <MDBModalBody>
                  <div style={{ padding: '20px' }}>
                    ...
                    <div className="mb-3">
                      <label htmlFor="moral" className="form-label">Vous ̻tes-vous senti anxieux, heureux, ou autre ? (note sur 10)</label>
                    ...
                    <div className="mb-3">
                      <label htmlFor="additionalActivity" className="form-label">Avez-vous bien mang̩ aujourd'hui ?</label>
                ...
                <MDBModalFooter>
                  <MDBBtn color="primary" onClick={handleSubmit}>Envoyez vos r̩ponses</MDBBtn>
                </MDBModalFooter>
              </MDBModalContent>
            </MDBModalDialog>
          </MDBModal>
